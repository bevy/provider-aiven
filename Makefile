...
PROJECT_REPO := github.com/codergolem/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-aiven_v4.0.0
...
REGISTRY_ORGS ?= codergolem/provider-aiven
IMAGES = $(PROJECT_NAME)
...
XPKG_REG_ORGS ?= codergolem/provider-aiven
